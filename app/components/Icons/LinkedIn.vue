<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 16 16" fill="none" stroke="currentColor"
    ...
    <path
      ...
      stroke-width="1"></path>
    <path d="m5 6.875 0 3.125" stroke-width="1"></path>
    <path d="m5 5 0 0.00625" stroke-width="1"></path>
    <path d="m7.5 10 0 -3.125" stroke-width="1"></path>
    <path d="M10 10v-1.875a1.25 1.25 0 0 0 -2.5 0" stroke-width="1"></path>
  </svg>
</template>
